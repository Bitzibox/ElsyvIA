...
const scenarios = {
  pme: {
    title: "Votre PME face à 4 défis. 4 solutions avec Elsy.",
    challenges: [
      { 
        id: 'admin', 
        icon: Briefcase, 
      ...
      { 
        id: 'data', 
        icon: BarChart3, 
        title: "Analyser vos données pour décider", 
        description: "Transformez vos données brutes en décisions stratégiques. Elsy peut analyser vos ventes, votre marketing et vos opérations pour identifier des tendances et des opportunités de croissance, le tout en langage clair.",
        chatPrompt: "Montrez-moi comment Elsy peut m'aider à analyser les données de mon entreprise pour prendre de meilleures décisions."
      },
    ]
  },
  public: {
