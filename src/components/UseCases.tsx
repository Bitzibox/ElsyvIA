      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-gradient-to-r from-teal-600 to-blue-600 rounded-2xl p-8 md:p-12 text-white text-center">
          <blockquote className="text-xl md:text-2xl font-medium mb-6">
            "ElsyvIA a transformé notre façon de travailler. L'automatisation de nos processus
            nous a fait gagner un temps précieux que nous pouvons maintenant consacrer
            à nos missions à forte valeur ajoutée."
          </blockquote>
          <cite className="text-blue-100">
            Directeur d'une collectivité territoriale
          </cite>
        </div>
      </div>
    </section>
